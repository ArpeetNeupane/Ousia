...
urlpatterns = [
    ...
    path('notifications/read-all/', NotificationMarkAllReadAPI.as_view(), name='notification_mark_all_read'),
    path('notifications/unread-count/', NotificationUnreadCountAPI.as_view(), name='notification_unread_count'),
]
